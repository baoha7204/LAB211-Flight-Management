...
public class Service implements IService {
    ...
    public void addNewFlight() {
        ...
        LocalDateTime departureTime = validator.inputDepatureTime("Input departure time in dd/MM/yyyy HH:mm format: ");
        LocalDateTime arrivalTime = validator.inputArrivalTime("Input arrival time in dd/MM/yyyy HH:mm format: ", departureTime);
    ...
    public void passengerReservation() {
        ...
        LocalDate requireDate = validator.inputDate("Input date in dd/MM/yyyy format: ");
        // Show searching flights
        List<Flight> showList = showRequiredFlights(requiredDepCity, requiredArriCity, requireDate);
        if (showList == null) {
            return;
        }
        // Choose flight in the list
        ...
        while (true) {
            ...
            if (!flightDao.checkFightExist(reservedFlightNumber, showList)) {
                System.err.println("This flight number does not exist. Please enter again!");
                continue;
            }
            break;
        }
        // Input passeger information
        ...
        String phoneNumber = validator.inputStringWithRegex("Please input correct format (10 digits with 0xxx)", "Input phone number: ", "^0\\d{9}$");
        ...
        System.out.println("Your reservation ID (Rxyzt with xyzt is number): " + reservationID);
    ...
    public void checkIn() {
        ...
        while (true) {
            ...
            if (!rervationDao.checkReservationExist(reservationId)) {
                System.err.println("This reservation id does not exist! Please check again!");
                continue;
            }
        ...
        // choose seat
        while (true) {
            choosedSeat = validator.inputStringWithRegex("Please input correct format (e.g A1)", "Please choose your seat (e.g A1): ", "^[a-zA-Z][1-6]$");
    ...
    public void showCrewMembers(List<CrewMember> list) {
        ...
        System.out.println(String.format("%-12s|%-18s|%-12s|%-12s|%-12s|%-25s|%-12s",
    ...
    public void deleteCrewMember() {
        ...
        if (validator.checkYesOrNo("Confirm delete (Y/N)?")) {
            ...
            // check if crew member has been assigned to flight
            if (deletedMember.isIsAvailable()) {
                ...
                System.err.println("Fail to delete because member has been assigned to flight!");
            }
        }
    }
